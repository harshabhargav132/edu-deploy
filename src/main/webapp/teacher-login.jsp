...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/styles.css"> <!-- Ensure the path to the CSS is correct -->
    <style>
        body {
        ...
        .reload-btn {
            background-color: #007bff; /* Background color for the reload button */
...
<body>
    ...
    <div class="main-content">
        <h2>Teacher Login</h2>
        <form id="loginForm" action="/teacher/login" method="post" onsubmit="return validateCaptcha()">
        ...
        <p>New teacher? <a href="/teacher/register">Register here</a></p>
    </div>
